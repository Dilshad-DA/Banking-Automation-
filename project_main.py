...
title=Label(win,text="UP Bank Automation",font=('Georgia',50,'bold'),bg='pink',fg='black')
title.pack()
...
img=Image.open("logo.jpg").resize((100,90))
bitmap_img=ImageTk.PhotoImage(img,master=win)

lbl_img=Label(win,image=bitmap_img)
lbl_img.place(relx=0.19,rely=0.01)

footer=Label(win,text="By:Dilshad Ahmad @ 98738**432\nDucat,Noida. Sec-16",font=('arial',15,'bold'),bg='pink',fg='black')
...
def forgotpass_screen():
    ...
    frm_title=Label(win,text="Password Recovery Screen",font=('arial',28,'bold','underline'),bg='powder blue',fg='red')
    frm_title.pack()
...
def newuser_screen():
    ...
    frm_title=Label(frm,text="Open New Account",font=('arial',30,'bold','underline'),bg='powder blue',fg='black')
    frm_title.pack()
